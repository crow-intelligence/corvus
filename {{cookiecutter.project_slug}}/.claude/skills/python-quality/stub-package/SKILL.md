...
1. **Run the stub generator.** Execute the script:
   ...
   ```
   python .claude/skills/python-quality/stub-package/stub_package.py <path> [flags]
   ```
...
- Always use the script at `.claude/skills/python-quality/stub-package/stub_package.py`. Do not
